    ...
    <aside className="flex h-full min-h-0 w-full flex-col bg-leaf-950 text-white">
      <div className="flex shrink-0 items-center justify-between gap-2 border-b border-white/10 px-4 py-3">
        <div className="min-w-0">
          <p className="font-display text-sm font-semibold">আপনার চ্যাট</p>
          <p className="truncate font-bengali text-xs text-white/65">
        ...
        {onClose && (
          <button
            type="button"
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center text-white/70 hover:bg-white/10 hover:text-white md:hidden"
      ...
      <div className="shrink-0 px-3 py-3">
        <button
          type="button"
          onClick={onNewChat}
          className="w-full bg-leaf-400 px-3 py-2 font-bengali text-sm font-semibold text-leaf-950 transition hover:bg-leaf-300"
        >
          + নতুন চ্যাট
        </button>
      </div>
      ...
      <div className="shrink-0 border-t border-white/10 px-3 py-3">
        <button
          type="button"
          onClick={onLogout}
          className="w-full px-3 py-2 text-left font-bengali text-sm text-white/70 hover:bg-white/10 hover:text-white"
        >
          লগআউট
        </button>
      </div>
