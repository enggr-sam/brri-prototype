...
_FIELD_PART_BN: dict[str, str] = {
    ...
    "sieve (three type)": "চালনি (তিন প্রকার)",
    "sieve shaft": "চালনি শ্যাফট",
    ...
    "bearing 6203 (sieve)": "বিয়ারিং 6203 (চালনি)",
...
_CAD_PART_BN: dict[str, str] = {
    ...
    "sieve frame-1": "চালনি ফ্রেম-১",
    "sieve frame-2": "চালনি ফ্রেম-২",
    "angle plate": "অ্যাঙ্গেল প্লেট",
    "sieve frame side part": "চালনি ফ্রেমের পাশের অংশ",
    "sieve small shaft": "চালনির ছোট শ্যাফট",
    "sieve top cover": "চালনির উপরের কভার",
...
_CURATED_BN: dict[int, str] = {
    ...
    11: "হপারের ফিড গেট ও চালনি",
    13: "এয়ার কন্ট্রোল লিভার ও চালনি ড্রাইভ আর্ম",
    14: "ব্লোয়ারে বাতাস ঢোকার মুখ (খোলা)",
    20: "মোটরের নিচের পুলি",
    23: "মোটর মাউন্ট ও ফ্রেমের পা",
    24: "চালনির ধান বের হওয়ার মুখ",
    27: "ভি-বেল্ট B65 মার্কিং (কাছ থেকে)",
    28: "চালনি (উপর থেকে)",
    29: "হপারের ফিড গেট (কাছ থেকে)",
    30: "চালনি ড্রাইভ আর্ম ও পিলো বিয়ারিং",
    31: "চালনির ক্র্যাঙ্ক ও পিলো বিয়ারিং",
    32: "পেছনের দিক — চিটা বের হওয়ার মুখ ও চালনি শ্যাফট",
    33: "ব্লোয়ার পুলি ও চালনির লিঙ্ক আর্ম",
    34: "চালনির কানেক্টিং রড (ছোট)",
    36: "চালনির কানেক্টিং রড (বড়)",
}
