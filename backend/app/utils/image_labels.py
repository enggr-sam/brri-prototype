...
_FIELD_PART_BN: dict[str, str] = {
    ...
    "sieve (three type)": "চালুনি (তিন প্রকার)",
    "sieve shaft": "চালুনি শ্যাফট",
    ...
    "bearing 6203 (sieve)": "বিয়ারিং 6203 (চালুনি)",
...
_CAD_PART_BN: dict[str, str] = {
    ...
    "sieve frame-1": "চালুনি ফ্রেম-১",
    "sieve frame-2": "চালুনি ফ্রেম-২",
    "angle plate": "অ্যাঙ্গেল প্লেট",
    "sieve frame side part": "চালুনি ফ্রেমের পাশের অংশ",
    "sieve small shaft": "চালুনির ছোট শ্যাফট",
    "sieve top cover": "চালুনির উপরের কভার",
...
_CURATED_BN: dict[int, str] = {
    ...
    11: "হপারের ফিড গেট ও চালুনি",
    13: "এয়ার কন্ট্রোল লিভার ও চালুনি ড্রাইভ আর্ম",
    14: "ব্লোয়ারে বাতাস ঢোকার মুখ (খোলা)",
    20: "মোটরের নিচের পুলি",
    23: "মোটর মাউন্ট ও ফ্রেমের পা",
    24: "চালুনির ধান বের হওয়ার মুখ",
    27: "ভি-বেল্ট B65 মার্কিং (কাছ থেকে)",
    28: "চালুনি (উপর থেকে)",
    29: "হপারের ফিড গেট (কাছ থেকে)",
    30: "চালুনি ড্রাইভ আর্ম ও পিলো বিয়ারিং",
    31: "চালুনির ক্র্যাঙ্ক ও পিলো বিয়ারিং",
    32: "পেছনের দিক — চিটা বের হওয়ার মুখ ও চালুনি শ্যাফট",
    33: "ব্লোয়ার পুলি ও চালুনির লিঙ্ক আর্ম",
    34: "চালুনির কানেক্টিং রড (ছোট)",
    36: "চালুনির কানেক্টিং রড (বড়)",
    40: "ব্রি শস্য ঝাড়াই যন্ত্র (BRRI Win 2024)",
    41: "হপার, চালুনি ও ড্রাইভ",
    42: "চালুনি থেকে চিটা উড়ছে",
    43: "হপারের ফিড গেট",
    44: "হপার থেকে ধান চালুনিতে পড়ছে",
    45: "ধান ও চিটার আউটলেট",
    46: "পরিষ্কার ধান বের হওয়ার মুখ",
}
